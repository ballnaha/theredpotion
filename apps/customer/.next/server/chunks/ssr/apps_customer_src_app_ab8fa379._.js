...
"[project]/apps/customer/src/app/utils/deepLink.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/customer/src/app/checkout/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/customer/src/app/utils/deepLink.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function CheckoutPage() {
    ...
    const { getCartItems, calculateTotalPrice, cartCount, isLoaded } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$hooks$2f$useCart$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    // States
    const [selectedAddress, setSelectedAddress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('home');
    const [selectedPayment, setSelectedPayment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('promptpay');
    const [selectedDeliveryTime, setSelectedDeliveryTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('asap');
    ...
    const [paymentStatus, setPaymentStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [showPaymentAlert, setShowPaymentAlert] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const addresses = [
        {
            ...
            phone: '081-234-5678',
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$house$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Home$3e$__["Home"]
        },
        {
            id: 'office',
            type: 'ออฟฟิศ',
            ...
            phone: '02-234-5678',
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$building$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Building$3e$__["Building"]
        }
    ];
    // Detect mobile environment
    const isMobile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMobileDevice"])();
    const isLineAppEnv = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isLineApp"])();
    const paymentMethods = [
        {
            ...
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$smartphone$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Smartphone$3e$__["Smartphone"],
            color: '#1976d2'
        },
        {
            id: 'cash',
            ...
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$banknote$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Banknote$3e$__["Banknote"],
            color: '#10b981'
        },
        {
            id: 'card',
            ...
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$credit$2d$card$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__CreditCard$3e$__["CreditCard"],
            color: '#7c3aed'
        },
        {
            id: 'wallet',
            ...
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$wallet$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Wallet$3e$__["Wallet"],
            color: '#f59e0b'
        }
    ];
    const deliveryTimes = [
    ...
    const handlePromptPayPayment = async ()=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isLineApp"])()) {
            const linePaySuccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openLinePay"])(paymentOptions);
            if (linePaySuccess) {
                // Wait for user to return from LINE Pay
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["detectAppReturn"])(()=>{
                    setIsProcessing(false);
                    router.push('/order-success');
                });
                return;
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMobileDevice"])()) {
            setPaymentStatus('กำลังเปิดแอปธนาคาร...');
            setShowPaymentAlert(true);
            const promptPaySuccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openPromptPayApp"])(paymentOptions);
            if (promptPaySuccess) {
    ...
    const handleWalletPayment = async ()=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMobileDevice"])()) {
            ...
            const walletSuccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openTrueMoneyWallet"])(paymentOptions);
            if (walletSuccess) {
    ...
    const handleCardPayment = async ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$deepLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["redirectToPaymentGateway"])({
            amount: finalTotal,
            orderId,
...
//# sourceMappingURL=apps_customer_src_app_ab8fa379._.js.map