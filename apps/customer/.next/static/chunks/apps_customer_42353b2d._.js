...
function LiffSafeWrapper({ children, fallback }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiffSafeWrapper.useEffect": ()=>{
            ...
            setIsClient(true);
            const initLiff = {
                "LiffSafeWrapper.useEffect.initLiff": async ()=>{
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$liff$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isInLiffEnvironment"])()) {
                        ...
                        const isReady = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$liff$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["waitForLiffReady"])(2000); // 2 second timeout
            ...
            }["LiffSafeWrapper.useEffect.initLiff"];
            // Add a fallback timer to ensure we never get stuck
            const fallbackTimer = setTimeout({
                "LiffSafeWrapper.useEffect.fallbackTimer": ()=>{
                    console.log('Fallback timer triggered, proceeding anyway');
                    setIsClient(true);
                    setIsLiffReady(true);
                }
            }["LiffSafeWrapper.useEffect.fallbackTimer"], 3000); // 3 second absolute maximum
            initLiff().finally({
                "LiffSafeWrapper.useEffect": ()=>{
...
//# sourceMappingURL=apps_customer_42353b2d._.js.map