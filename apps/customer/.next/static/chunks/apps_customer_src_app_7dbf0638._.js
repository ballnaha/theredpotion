...
"[project]/apps/customer/src/app/utils/tenantNavigation.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
// Tenant-Aware Navigation Utility
__turbopack_context__.s({
    "getTenantAwareUrl": (()=>getTenantAwareUrl),
    "navigateWithTenant": (()=>navigateWithTenant),
    "useTenantNavigation": (()=>useTenantNavigation)
});
const getTenantAwareUrl = (path, tenantId)=>{
    if ("TURBOPACK compile-time falsy", 0) {
        "TURBOPACK unreachable";
    }
    const currentUrl = new URL(window.location.href);
    const currentTenant = tenantId || currentUrl.searchParams.get('tenant');
    // If we have a tenant, preserve it in the URL
    if (currentTenant) {
        const newUrl = new URL(path, window.location.origin);
        newUrl.searchParams.set('tenant', currentTenant);
        return newUrl.pathname + newUrl.search;
    }
    return path;
};
const navigateWithTenant = (path, tenantId)=>{
    if ("TURBOPACK compile-time falsy", 0) {
        "TURBOPACK unreachable";
    }
    const tenantAwareUrl = getTenantAwareUrl(path, tenantId);
    window.location.href = tenantAwareUrl;
};
const useTenantNavigation = (tenantId)=>{
    ...
    const getUrl = (path)=>{
        return getTenantAwareUrl(path, tenantId);
    };
    return {
        navigateTo,
        getUrl
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$tenantNavigation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/customer/src/app/utils/tenantNavigation.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function HomePage({ params, searchParams }) {
    ...
    const { navigateTo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$tenantNavigation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTenantNavigation"])(tenantId);
...
_s(HomePage, "WxHX9TQObSp8OYFRuCQRlQv28mg=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$customer$2f$src$2f$app$2f$utils$2f$tenantNavigation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTenantNavigation"]
    ];
});
_c = HomePage;
var _c;
...
//# sourceMappingURL=apps_customer_src_app_7dbf0638._.js.map