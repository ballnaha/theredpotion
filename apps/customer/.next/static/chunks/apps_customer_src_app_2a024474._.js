...
const useCart = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCart.useEffect": ()=>{
            ...
            if (isInLiff) {
                // In LIFF environment, wait a bit longer for everything to be ready
                setTimeout({
                    "useCart.useEffect": ()=>{
                        setIsMounted(true);
                    }
                }["useCart.useEffect"], 1000);
            } else {
                // Normal browser
                setIsMounted(true);
            }
...
_s(CheckoutPage, "B+A0r74DmM+sVu3EK9RNJEz5tp8=", false, function() {
    return [
...
//# sourceMappingURL=apps_customer_src_app_2a024474._.js.map